...
type BookstoreClient interface {
	...
	// archive a book.
	ArchiveBook(ctx context.Context, in *ArchiveBookRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
...
func (c *bookstoreClient) ArchiveBook(ctx context.Context, in *ArchiveBookRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
...
type BookstoreServer interface {
	...
	// archive a book.
	ArchiveBook(context.Context, *ArchiveBookRequest) (*longrunningpb.Operation, error)
	// An aep-compliant Create method for book-edition.
...
func (UnimplementedBookstoreServer) ArchiveBook(context.Context, *ArchiveBookRequest) (*longrunningpb.Operation, error) {
